...
class Engine(object):
    ...
    @torch.no_grad()
    def _evaluate_last(self,distmat_1,distmat_2,distmat_3,distmat_4,distmat_5, q_pids, g_pids, epoch, queryloader=None, galleryloader=None, testdataset=None,
                  dist_metric='euclidean', normalize_feature=False, save_dir='', use_metric_cuhk03=False,
                  ranks=[1, 5, 10, 20],
                  rerank=False, multi_scale_interpolate_mode='bilinear', multi_scale=(1,),
