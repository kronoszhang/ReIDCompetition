...
from torchreid.models.senet import SEResNeXtBottleneck_IBN_A
def pcb_p6(num_classes, loss='softmax', pretrained=True, **kwargs):
    model = PCB(
        num_classes=num_classes,
        loss=loss,
        block=SEResNeXtBottleneck_IBN_A,  # SEResNeXtBottleneck_IBN_A  Bottleneck
        layers=[3, 4, 23, 3],  #  [3, 4, 23, 3]    [3, 4, 6, 3]
        last_stride=1,
        parts=6,
        reduced_dim=256,
        nonlinear='relu',
