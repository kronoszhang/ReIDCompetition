...
__all__ = ['save_checkpoint', 'load_checkpoint', 'resume_from_checkpoint', 'resume_from_checkpoint_fine_tune',
...
def resume_from_checkpoint_fine_tune(fpath, model, optimizer=None):
    print('Loading checkpoint from "{}"'.format(fpath))
    checkpoint = load_checkpoint(fpath)
