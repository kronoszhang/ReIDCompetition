...
import torchreid
from torchreid.utils import AverageMeter, visualize_ranked_results, save_checkpoint, re_ranking, mkdir_if_missing, visualize_ranked_results_and_show_rank_list
...
class Engine(object):
    ...
    def _evaluate(self, epoch, queryloader=None, galleryloader=None, testdataset=None,
        ...
        if rerank:
            ...
            distmat_qq = metrics.compute_distance_matrix(qf, qf, dist_metric)
            distmat_gg = metrics.compute_distance_matrix(gf, gf, dist_metric)
            distmat = re_ranking(distmat, distmat_qq, distmat_gg, k1=10, k2=3, lambda_value=0.9)  # 10, 2, 0.7   8, 4, 0.9
        ...
        if not return_json:
           ...
           """visualize_ranked_results_and_show_rank_list(
                distmat,
                testdataset,
