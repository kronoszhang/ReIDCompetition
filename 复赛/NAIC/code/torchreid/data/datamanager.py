...
class MyDataset(Dataset):
    ...
    def __init__(self, root="project/ywchong/ywchong/CODE/zc/AIC/data", **kwargs):
        ...
        #self.train_dir = osp.join(root, "train/trainset_remove_1_2_1000_800_700_600")  # change here to adjust the train set
        #self.val_query_dir = osp.join(root, "val/valset/query")  # change here to adjust the val set query
        #self.val_gallery_dir = osp.join(root, "val/valset/gallery")  # change here to adjust the val set gallery
        #self.query_dir = osp.join(root, "test/testset/query_a")  # true query
        #self.gallery_dir = osp.join(root, "test/testset/gallery_a")  # true gallery, no pid label
